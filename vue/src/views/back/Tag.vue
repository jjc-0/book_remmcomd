...
<template>
  <div class="content-container">
    ...
    <div class="header-section">
      <el-input v-model="searchForm.keyword" placeholder="请输入标签名称" class="filter-input" :prefix-icon="Search" clearable/>
    ...
    <el-card>
      <el-table :data="tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="info" label="标签说明"/>
    ...
    <el-dialog v-model="dialogFormVisible" :title="form.id ? '编辑' : '新增'" width="30%" center>
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="标签说明">
          <el-input v-model="form.info" type="textarea" placeholder="请输入标签说明"/>
        </el-form-item>
