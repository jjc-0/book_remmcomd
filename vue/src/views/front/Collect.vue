  ...
  <div class="home-container">
    ...
    <div class="good-grid">
      <div v-for="good in goods" :key="good.id" class="good-card">
        <img :src="good.bookImg" class="good-image">
        <el-popconfirm
        ...
        <div>
          <el-button link style="color: #0a6b37" @click="router.push('/front/goodsDetail?id=' + good.bookId)">
            {{ good.bookName }}
          </el-button>
        </div>
        <div class="good-info">
          <span class="price">¥{{ good.bookPrice }}</span>
        </div>
      </div>
    </div>
