...
<template>
  <div style="width: 80%;margin: 0 auto;padding: 24px 20px;background: transparent;min-height: 100vh;">
    ...
    <div style="margin: 10px 0">
      <el-input style="width: 400px" placeholder="输入图书名称进行搜索" v-model="keyword"></el-input>
    ...
    <el-table :data="tableData" style="width: 100%;border: none;">
      ...
      <el-table-column label="图书封面" width="140">
      ...
      <el-table-column prop="name" label="图书名称" width="130">
        <template #default="scope">
          <el-tooltip class="item" effect="dark" :content="scope.row.name" placement="top">
            <el-button
                @click="router.push('/front/goodsDetail?id=' + scope.row.bookId)"
                link
      ...
      <el-table-column prop="num" label="图书数量" width="80"></el-table-column>
      ...
      <el-table-column label="订单评价" v-if="activeTab==='已完成'">
        <el-table-column prop="rate" label="评分" width="150">
          <template #default="scope">
            <el-rate :model-value="scope.row.rate || 0" disabled></el-rate>
          </template>
        </el-table-column>
...
.payment-method-card:hover {
  border-color: #4084d9;
  box-shadow: 0 2px 12px rgba(64, 132, 217, 0.15);
}
