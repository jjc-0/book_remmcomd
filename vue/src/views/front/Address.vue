...
<template>
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif;width: 70%;margin: 0 auto;padding: 24px 20px;background: transparent;min-height: 100vh;">
